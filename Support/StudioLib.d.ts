...
/**
* @description Controls a texture, which is using object's segmentation mask, and its placement using information provided by Object tracking.
*/
interface ObjectTrackingMaskedTextureProvider extends TextureProvider {
    /**
    * @description Index of the tracked object to use.
    */
    objectIndex: number
...
/**
* @description Controls a normals texture and its placement using information provided by Object tracking.
*/
interface ObjectTrackingNormalsTextureProvider extends TextureProvider {
    /**
    * @description Index of the tracked object to use for normals.
    */
    objectIndex: number
}
